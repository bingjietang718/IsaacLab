...
ASSET_DIR = '/home/yijieg/Downloads/assembly_asset'
...
class Extraction(DisassemblyTask):
    ...
    fingertip_centered_pos_initial: list = [0.0, 0.0, 0.2]  # initial position of midpoint between fingertips above table
