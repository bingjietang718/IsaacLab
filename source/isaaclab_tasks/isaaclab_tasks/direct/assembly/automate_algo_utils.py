...
def get_prev_success_init(
    ...
    return torch.tensor(held_asset_pose[selected_indices], device=device), \
            torch.tensor(fixed_asset_pose[selected_indices], device=device)

def model_succ_w_gmm(
    held_asset_pose, 
    fixed_asset_pose, 
    success
):
